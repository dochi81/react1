    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    <input type="number" value={price} onChange={(e) => setPrice(e.target.value)} placeholder='가격' />원
                </div>
                <div>
                    <input type="text" value={content} onChange={(e) => setContent(e.target.value)} placeholder='내용' />
                </div>
                <div>
                    <input type="number" min="0" value={quantity} onChange={(e) => setQuantity(e.target.value)} placeholder='수량' />
                </div>
                <div>
